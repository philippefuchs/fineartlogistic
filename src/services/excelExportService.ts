...
export const exportFinancialOffertoXLSX = (
    ...
    try {
        ...
        const summaryRows = [
            ...
            ['Coût Logistique (Transport, Équipes, Per Diems, Annexes)', TotalsValue(totals.totalCost - (totals.packingCost || 0)), '€'],
...
export const exportCompleteQuoteToXLSX = (
    ...
    try {
        ...
        const summaryRows = [
            ...
            ['Équipe (Personnel & Séjour)', quote.teamCost_eur, '€'],
            ['Frais de Gestion & Annexes', quote.ancillaryCost_eur, '€'],
